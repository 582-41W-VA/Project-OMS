    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('Urgent', 'Urgent'), ('Normal', 'Normal')], max_length=50)),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Complete', 'Complete'), ('Attention Required', 'Attention Required')], default='Pending', max_length=50)),
                ...
                ('order_assigned_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_orders', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
